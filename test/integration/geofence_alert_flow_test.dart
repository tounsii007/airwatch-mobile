...
void main() {
  ...
  group('Geofence alert end-to-end', () {
    test('aircraft inside an active fence appears in geofenceAlertsProvider',
        () async {
      final inside = AircraftState(
        icao24: 'DLH400',
        callsign: 'DLH400',
        latitude: 50.04, longitude: 8.56, // 0.3 km from FRA
      ...
      // Add a fence at FRA.
      container.read(geofencesProvider.notifier).add(GeoFence(
            id: 'fra-50',
            name: 'FRA 50 km',
    ...
    test('disabled fence produces no hits even when aircraft is inside',
        () async {
      final inside = AircraftState(
        icao24: 'DLH400',
        callsign: 'DLH400',
        latitude: 50.04, longitude: 8.56,
      );
      final container = ProviderContainer(overrides: [
        aircraftStreamProvider.overrideWith((ref) {
