...
void main() {
  group('FleetInfoSection', () {
    testWidgets('renders nothing on a total miss', (tester) async {
      await tester.pumpWidget(_wrap(FleetInfoSection(
        icao24: 'abc123',
        isDark: true,
    ...
    testWidgets('does not render when icao24 is wrong length',
        (tester) async {
      await tester.pumpWidget(_wrap(FleetInfoSection(
        icao24: 'xx',
        isDark: true,
  ...
  group('RouteStatsBadge', () {
    testWidgets('renders nothing on missing IATA codes', (tester) async {
      await tester.pumpWidget(_wrap(RouteStatsBadge(
        dep: null,
        arr: 'JFK',
        primary: const Color(0xFF00BFA5),
        isDark: true,
    ...
    testWidgets('renders all 3 buckets on a populated route',
        (tester) async {
      await tester.pumpWidget(_wrap(RouteStatsBadge(
        dep: 'FRA',
        arr: 'JFK',
