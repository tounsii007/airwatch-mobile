...
void main() {
  ...
  group('NotamPanel', () {
    testWidgets('shows "no NOTAMs reported" on an empty list', (tester) async {
      await tester.pumpWidget(
        _wrap(
          NotamPanel(
            icao: 'EDDF',
  ...
  group('AtcAudioPanel', () {
    testWidgets('falls back to "Search on LiveATC" when no feeds', (
      ...
      await tester.pumpWidget(
        _wrap(
          AtcAudioPanel(
            icao: 'EDDF',
            service: _StubAtc(result: const AtcFeedsResult(icao: 'EDDF')),
          ),
        ),
      );
      await tester.pump();
    ...
    testWidgets('renders chip per feed on populated catalog', (tester) async {
      await tester.pumpWidget(
        _wrap(
          AtcAudioPanel(
            icao: 'EDDF',
