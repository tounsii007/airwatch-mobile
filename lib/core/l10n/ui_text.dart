...
// `app_strings.dart` re-exports `AppStrings` so this single import is enough.
...
class UiText {
  static const _translations = <String, Map<String, String>>{
    'en': {
      ...
      'airport_weather': 'Airport Weather',
      'weather_emoji': 'Weather emoji on labels',
      'aircraft_photos': 'Aircraft Photos',
      'show_photo_hint': 'Show photo on flight details',
      'codeshare_short': 'CS',
      'codeshare_with': 'Codeshare with {0}',
    ...
    'de': {
      ...
      'iata_codes': 'IATA-Codes',
      'airport_weather': 'Flughafen-Wetter',
      'weather_emoji': 'Wetter-Emoji auf Labels',
      'aircraft_photos': 'Flugzeugfotos',
      'show_photo_hint': 'Foto auf Flugdetails anzeigen',
      'codeshare_short': 'CS',
      'codeshare_with': 'Codeshare mit {0}',
    ...
    'fr': {
      ...
      'airport_weather': 'Météo aéroport',
      'weather_emoji': 'Emoji météo sur les étiquettes',
      'aircraft_photos': 'Photos avion',
      'show_photo_hint': 'Afficher la photo dans les détails',
      'codeshare_short': 'CS',
      'codeshare_with': 'Code-share avec {0}',
