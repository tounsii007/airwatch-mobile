...
final Map<String, _LocalizedNames> _curated = {
  ...
  'Nuremberg':   _LocalizedNames(en: 'Nuremberg',  de: 'Nürnberg',   fr: 'Nuremberg'),
  'Dusseldorf':  _LocalizedNames(en: 'Dusseldorf', de: 'Düsseldorf', fr: 'Düsseldorf'),
  ...
  'Marseille':   _LocalizedNames(en: 'Marseille',  de: 'Marseille',  fr: 'Marseille'),
  'Strasbourg':  _LocalizedNames(en: 'Strasbourg', de: 'Straßburg',  fr: 'Strasbourg'),
  ...
  'Copenhagen':  _LocalizedNames(en: 'Copenhagen', de: 'Kopenhagen', fr: 'Copenhague'),
  'Stockholm':   _LocalizedNames(en: 'Stockholm',  de: 'Stockholm',  fr: 'Stockholm'),
  'Gothenburg':  _LocalizedNames(en: 'Gothenburg', de: 'Göteborg',   fr: 'Göteborg'),
  ...
  'Bratislava':  _LocalizedNames(en: 'Bratislava', de: 'Bratislava', fr: 'Bratislava'),
  'Ljubljana':   _LocalizedNames(en: 'Ljubljana',  de: 'Ljubljana',  fr: 'Ljubljana'),
  ...
  'Thessaloniki': _LocalizedNames(en: 'Thessaloniki', de: 'Thessaloniki', fr: 'Thessalonique'),
  ...
  'Saint Petersburg':
    _LocalizedNames(en: 'Saint Petersburg', de: 'Sankt Petersburg', fr: 'Saint-Pétersbourg'),
  ...
  'Edinburgh':   _LocalizedNames(en: 'Edinburgh',  de: 'Edinburgh',  fr: 'Édimbourg'),
  ...
  'Casablanca':  _LocalizedNames(en: 'Casablanca', de: 'Casablanca', fr: 'Casablanca'),
  'Marrakech':   _LocalizedNames(en: 'Marrakech',  de: 'Marrakesch', fr: 'Marrakech'),
  'Jeddah':      _LocalizedNames(en: 'Jeddah',     de: 'Dschidda',   fr: 'Djeddah'),
  'Riyadh':      _LocalizedNames(en: 'Riyadh',     de: 'Riad',       fr: 'Riyad'),
  'Abu Dhabi':   _LocalizedNames(en: 'Abu Dhabi',  de: 'Abu Dhabi',  fr: 'Abou Dabi'),
  ...
  'Jerusalem':   _LocalizedNames(en: 'Jerusalem',  de: 'Jerusalem',  fr: 'Jérusalem'),
  ...
  'Kuwait City': _LocalizedNames(en: 'Kuwait City', de: 'Kuwait-Stadt', fr: 'Koweït'),
  ...
  'Johannesburg':_LocalizedNames(en: 'Johannesburg', de: 'Johannesburg', fr: 'Johannesbourg'),
  ...
  'Addis Ababa': _LocalizedNames(en: 'Addis Ababa', de: 'Addis Abeba', fr: 'Addis-Abeba'),
  'Khartoum':    _LocalizedNames(en: 'Khartoum',   de: 'Khartum',    fr: 'Khartoum'),
  'Dar es Salaam':
    _LocalizedNames(en: 'Dar es Salaam', de: 'Daressalam', fr: 'Dar es Salaam'),
  ...
  'Chongqing':   _LocalizedNames(en: 'Chongqing',  de: 'Chongqing',  fr: 'Chongqing'),
  ...
  'Hong Kong':   _LocalizedNames(en: 'Hong Kong',  de: 'Hongkong',   fr: 'Hong Kong'),
  ...
  'Singapore':   _LocalizedNames(en: 'Singapore',  de: 'Singapur',   fr: 'Singapour'),
  'Bangkok':     _LocalizedNames(en: 'Bangkok',    de: 'Bangkok',    fr: 'Bangkok'),
  'Hanoi':       _LocalizedNames(en: 'Hanoi',      de: 'Hanoi',      fr: 'Hanoï'),
  'Ho Chi Minh City':
    _LocalizedNames(en: 'Ho Chi Minh City', de: 'Ho-Chi-Minh-Stadt', fr: 'Hô Chi Minh-Ville'),
  'Manila':      _LocalizedNames(en: 'Manila',     de: 'Manila',     fr: 'Manille'),
  'Jakarta':     _LocalizedNames(en: 'Jakarta',    de: 'Jakarta',    fr: 'Jakarta'),
  'Kuala Lumpur':_LocalizedNames(en: 'Kuala Lumpur', de: 'Kuala Lumpur', fr: 'Kuala Lumpur'),
  'Yangon':      _LocalizedNames(en: 'Yangon',     de: 'Rangun',     fr: 'Rangoun'),
  'Phnom Penh':  _LocalizedNames(en: 'Phnom Penh', de: 'Phnom Penh', fr: 'Phnom Penh'),
  'Vientiane':   _LocalizedNames(en: 'Vientiane',  de: 'Vientiane',  fr: 'Vientiane'),
  ...
  'Bangalore':   _LocalizedNames(en: 'Bangalore',  de: 'Bangalore',  fr: 'Bangalore'),
  'Hyderabad':   _LocalizedNames(en: 'Hyderabad',  de: 'Hyderabad',  fr: 'Hyderabad'),
  'Karachi':     _LocalizedNames(en: 'Karachi',    de: 'Karatschi',  fr: 'Karachi'),
  'Lahore':      _LocalizedNames(en: 'Lahore',     de: 'Lahore',     fr: 'Lahore'),
  'Islamabad':   _LocalizedNames(en: 'Islamabad',  de: 'Islamabad',  fr: 'Islamabad'),
  'Colombo':     _LocalizedNames(en: 'Colombo',    de: 'Colombo',    fr: 'Colombo'),
  'Dhaka':       _LocalizedNames(en: 'Dhaka',      de: 'Dhaka',      fr: 'Dacca'),
  'Kathmandu':   _LocalizedNames(en: 'Kathmandu',  de: 'Kathmandu',  fr: 'Katmandou'),
  ...
  'Ulaanbaatar': _LocalizedNames(en: 'Ulaanbaatar', de: 'Ulan-Bator', fr: 'Oulan-Bator'),

  // ── North America ────────────────────────────────────────────────────────
  'New York':    _LocalizedNames(en: 'New York',   de: 'New York',   fr: 'New York'),
  'Los Angeles': _LocalizedNames(en: 'Los Angeles', de: 'Los Angeles', fr: 'Los Angeles'),
  'Chicago':     _LocalizedNames(en: 'Chicago',    de: 'Chicago',    fr: 'Chicago'),
  'Philadelphia':_LocalizedNames(en: 'Philadelphia', de: 'Philadelphia', fr: 'Philadelphie'),
  'San Francisco':_LocalizedNames(en: 'San Francisco', de: 'San Francisco', fr: 'San Francisco'),
  ...
  'Las Vegas':   _LocalizedNames(en: 'Las Vegas',  de: 'Las Vegas',  fr: 'Las Vegas'),
  'Phoenix':     _LocalizedNames(en: 'Phoenix',    de: 'Phoenix',    fr: 'Phoenix'),
  'Washington':  _LocalizedNames(en: 'Washington', de: 'Washington', fr: 'Washington'),
  'Orlando':     _LocalizedNames(en: 'Orlando',    de: 'Orlando',    fr: 'Orlando'),
  'Detroit':     _LocalizedNames(en: 'Detroit',    de: 'Detroit',    fr: 'Détroit'),
  'Pittsburgh':  _LocalizedNames(en: 'Pittsburgh', de: 'Pittsburgh', fr: 'Pittsburgh'),
  'Minneapolis': _LocalizedNames(en: 'Minneapolis', de: 'Minneapolis', fr: 'Minneapolis'),
  'Charlotte':   _LocalizedNames(en: 'Charlotte',  de: 'Charlotte',  fr: 'Charlotte'),
  'Nashville':   _LocalizedNames(en: 'Nashville',  de: 'Nashville',  fr: 'Nashville'),
  'New Orleans': _LocalizedNames(en: 'New Orleans', de: 'New Orleans', fr: 'La Nouvelle-Orléans'),
  'Salt Lake City':
    _LocalizedNames(en: 'Salt Lake City', de: 'Salt Lake City', fr: 'Salt Lake City'),
  'Kansas City': _LocalizedNames(en: 'Kansas City', de: 'Kansas City', fr: 'Kansas City'),
  'St. Louis':   _LocalizedNames(en: 'St. Louis',  de: 'St. Louis',  fr: 'Saint-Louis'),
  'Cincinnati':  _LocalizedNames(en: 'Cincinnati', de: 'Cincinnati', fr: 'Cincinnati'),
  'San Diego':   _LocalizedNames(en: 'San Diego',  de: 'San Diego',  fr: 'San Diego'),
  ...
  'Vancouver':   _LocalizedNames(en: 'Vancouver',  de: 'Vancouver',  fr: 'Vancouver'),
  ...
  // ── Latin America ────────────────────────────────────────────────────────
  'Mexico City': _LocalizedNames(en: 'Mexico City', de: 'Mexiko-Stadt', fr: 'Mexico'),
  'Cancun':      _LocalizedNames(en: 'Cancún',     de: 'Cancún',     fr: 'Cancún'),
  'Guadalajara': _LocalizedNames(en: 'Guadalajara', de: 'Guadalajara', fr: 'Guadalajara'),
  'Sao Paulo':   _LocalizedNames(en: 'São Paulo',  de: 'São Paulo',  fr: 'São Paulo'),
  'Rio de Janeiro':
    _LocalizedNames(en: 'Rio de Janeiro', de: 'Rio de Janeiro', fr: 'Rio de Janeiro'),
  'Brasilia':    _LocalizedNames(en: 'Brasília',   de: 'Brasília',   fr: 'Brasilia'),
  'Buenos Aires':_LocalizedNames(en: 'Buenos Aires', de: 'Buenos Aires', fr: 'Buenos Aires'),
  'Lima':        _LocalizedNames(en: 'Lima',       de: 'Lima',       fr: 'Lima'),
  'Santiago':    _LocalizedNames(en: 'Santiago',   de: 'Santiago de Chile', fr: 'Santiago du Chili'),
  ...
  'Montevideo':  _LocalizedNames(en: 'Montevideo', de: 'Montevideo', fr: 'Montevideo'),
  'Asuncion':    _LocalizedNames(en: 'Asunción',   de: 'Asunción',   fr: 'Asuncion'),
  'Panama City': _LocalizedNames(en: 'Panama City', de: 'Panama-Stadt', fr: 'Panama'),
  'Guatemala City':
    _LocalizedNames(en: 'Guatemala City', de: 'Guatemala-Stadt', fr: 'Guatemala'),
  'San Jose':    _LocalizedNames(en: 'San José',   de: 'San José',   fr: 'San José'),
  'Havana':      _LocalizedNames(en: 'Havana',     de: 'Havanna',    fr: 'La Havane'),
  'Santo Domingo':
    _LocalizedNames(en: 'Santo Domingo', de: 'Santo Domingo', fr: 'Saint-Domingue'),

  // ── Oceania ──────────────────────────────────────────────────────────────
  'Sydney':      _LocalizedNames(en: 'Sydney',     de: 'Sydney',     fr: 'Sydney'),
  'Melbourne':   _LocalizedNames(en: 'Melbourne',  de: 'Melbourne',  fr: 'Melbourne'),
...
String _normalize(String name) {
  ...
  const withDiacritics = 'áàâäãåçéèêëíìîïñóòôöõøßúùûüýÿÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕØÚÙÛÜÝ';
...
Future<void> _doLoad(Dio dio) async {
  try {
    ...
    for (final raw in data.values) {
      ...
      _registerEntry(_LocalizedNames(
        en: en,
        de: raw['de'] as String?,
        fr: raw['fr'] as String?,
      ));
