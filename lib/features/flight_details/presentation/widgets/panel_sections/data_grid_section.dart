...
class PanelDataGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final vsValue = UiText.formatVerticalRate(
      context,
      settings,
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: FlightDataCard(
                  title1: context.s.altitude,
                  value1: UiText.formatAltitude(
                    context,
                    settings,
                    aircraft.altitude,
                  ),
                  title2: context.s.heading,
                  value2: aircraft.heading.toStringAsFixed(0),
              ...
              Expanded(
                child: FlightDataCard(
                  title1: context.s.speed,
                  value1: UiText.formatSpeed(
                    context,
                    settings,
                    aircraft.velocity,
                  ),
                  title2: context.s.verticalSpeed,
                  value2: vsValue,
          ...
          Row(
            children: [
              Expanded(
                child: FlightDataCard(
                  title1: 'LAT',
                  value1: aircraft.latitude?.toStringAsFixed(4) ?? '--',
              ...
              Expanded(
                child: FlightDataCard(
                  title1: 'LON',
                  value1: aircraft.longitude?.toStringAsFixed(4) ?? '--',
                  borderColor: AppColors.altitudeLow, // Yellow
                  isDark: isDark,
                ),
              ),
