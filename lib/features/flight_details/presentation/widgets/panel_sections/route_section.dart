              ...
              children: [
                ...
                Expanded(child: Column(children: [
                  ...
                  if (hasDep) ...[
                    ...
                    Builder(builder: (_) {
                      final rawCity = route!.depCity ?? AirportDatabase.getCity(route!.departureAirport);
                    ...
                    Builder(builder: (_) {
                      ...
                      final canonicalCountry = CountryDatabase.displayName(country);
                      final displayCountry = localizeCountry(canonicalCountry, locale);
                      return FittedBox(
                ...
                Expanded(child: Column(children: [
                  ...
                  if (hasArr) ...[
                    Builder(builder: (_) {
                      final rawCity = route!.arrCity ?? AirportDatabase.getCity(route!.arrivalAirport);
                      if (rawCity.isEmpty) return const SizedBox.shrink();
                      final city = localizeCity(rawCity, locale);
                      return Text(city, style: TextStyle(fontFamily: UiConstants.bodyFont, fontSize: UiConstants.microFontSize,
                          color: isDark ? AppColors.textSecondary : UiConstants.lightTextSecondary),
